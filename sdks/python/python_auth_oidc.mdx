...
description: "Authenticate with Azure AD using the Python SDK."
---
...
<Image src="/images/cdf/dev/guides/sdk/tenant-and-client-id.png" alt="Client and tenant id" width="750px" />
...
You can authenticate the Python SDK with Azure AD by **using a token** retrieved with user credentials. To find the examples, see [Credential Providers](https://cognite-sdk-python.readthedocs-hosted.com/en/latest/credential_providers.html#credential-providers).
