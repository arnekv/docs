...
description: "Learn how to get started with the Python SDK, including installation and basic usage."
---
...
```python title="Authenticate with OAuthClientCredentials"
...
```python title="Custom token provider"
from cognite.client import CogniteClient, ClientConfig
...
```python title="Instantiate client and check login status"
...
```python title="Create a root asset"
from cognite.client import CogniteClient
...
```python title="Create asset hierarchy"
from cognite.client import CogniteClient
from cognite.client.data_classes import Asset
...
```python title="Error handling for asset hierarchy creation"
...
```python title="Retrieve events for asset subtree"
from cognite.client import CogniteClient
from cognite.client.data_classes import Asset
...
```python title="Retrieve files and time series for asset subtree"
