...
They include [**prompts**](#prompts-and-prompt-engineering) with **goals** and **instructions**, industry-relevant [**tools**](#tools), and access to industrial data stored in the Cognite Data Fusion (CDF) [**knowledge graph**](#knowledge-graphs).
...
### Language models[​](#language-models "Direct link to heading")
...
### Knowledge graphs[​](#knowledge-graphs "Direct link to heading")
...
### Prompts and prompt engineering[​](#prompts-and-prompt-engineering "Direct link to heading")
