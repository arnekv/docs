...
description: "Atlas AI agents solve specific industrial business problems."
---

Atlas AI agents use generative AI (genAI) language models to solve specific industrial business problems, such as providing insights into historical and planned maintenance and analyzing time series data for root cause analysis.
...
![Atlas AI agent](https://docs.cognite.com/assets/images/concepts-a5ff7c15b9f352a2a4be544ce2a060d0.svg)

Agents interact with humans to meet predetermined goals. Humans set goals, and the AI agent suggests the best actions to take to achieve those goals.
...
Cognite Data Fusion (CDF) has [data modeling features](/cdf/dm/dm_concepts) and [out-of-the-box data models](/cdf/dm/dm_reference/dm_core_data_model) to help you build a structured, flexible, and contextualized **knowledge graph** of your industrial data.
