# Set up a Cognite Data Fusion (CDF) project
...
<!-- If there are no prerequsites, use this boilerplate text:

There are no prerequisites for this tutorial. However, readers with some IT knowledge or experience will find the concepts easier to understand. -->
