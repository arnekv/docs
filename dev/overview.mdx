...
Explore the [API](../api) and [SDKs](/sdks/) and learn how you can use **Cognite Data Fusion** (CDF) to:
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" arrow="yes" href="/dev/quickstart">
  ...
  <Card title="Resource types" icon="toy-brick" href="/dev/concepts/resource_types/overview">
    ...
    <Card title="API guides" icon="toy-brick" href="/dev/concepts/resource_types/index">
    Explore the different resource types in CDF and how to work with them.
  </Card>
</CardGroup>
