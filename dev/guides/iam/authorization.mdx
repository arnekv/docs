---
title: "Authorization in Cognite Data Fusion"
description: "Learn how authorization and role-based access control work in Cognite Data Fusion (CDF), including groups, capabilities, security categories, and example scenarios."
---
...
A principal is associated with, or determined to be a member of, one or more groups managed in Azure AD:
...
3. A user makes a request against Cognite Data Fusion, the user is authenticated against Azure AD, and then:
   ...
   - The user will be recognized as a member of any Cognite Data Fusion group whose sourceId matches the GUID of a group they're in Azure AD.
