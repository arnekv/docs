...
description: "Learn how to upload multiple 3D models to Cognite Data Fusion (CDF) using the API and SDKs, including prerequisites and step-by-step instructions."
---
